...
class AppColors {
  ...
  // Custom Gradients/Background colors used
  static const Color navyPanelBg1 = Color(0xFF001B36);
  static const Color navyPanelBg2 = Color(0xFF00152A);
  static const Color goldButtonBg1 = Color(0xFFFFD96B);
  static const Color goldButtonBg3 = Color(0xFFC9972C);
